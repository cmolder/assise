...
#define MLFS_PERMISSIONS defined(PERMISSIONS) && defined(USE_LEASE)
#define MLFS_SECURE_MAPPING defined(SECURE_MAPPING) && defined(USE_LEASE) && defined(PERMISSIONS) && defined(LIBFS)
